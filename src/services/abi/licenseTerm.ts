export const licenseTermAbi = [
  ...
  { inputs: [], name: 'LicenseRegistry__CallerNotLicensingModule', type: 'error' },
  {
  ...
  { inputs: [], name: 'LicenseRegistry__NoParentIp', type: 'error' },
  {
  ...
  },
  {
    inputs: [
      { internalType: 'address', name: 'ipId', type: 'address' },
      { internalType: 'address', name: 'licenseTemplate', type: 'address' },
      { internalType: 'address', name: 'newLicenseTemplate', type: 'address' },
    ],
  ...
  { inputs: [], name: 'LicenseRegistry__ZeroAccessManager', type: 'error' },
  { inputs: [], name: 'LicenseRegistry__ZeroDisputeModule', type: 'error' },
  { inputs: [], name: 'LicenseRegistry__ZeroLicensingModule', type: 'error' },
  { inputs: [], name: 'LicensingModule__DerivativesCannotAddLicenseTerms', type: 'error' },
  {
    inputs: [
      { internalType: 'address', name: 'licenseTemplate', type: 'address' },
      { internalType: 'uint256', name: 'licenseTermsId', type: 'uint256' },
  ...
  },
  {
    ...
    inputs: [
      ...
      { indexed: false, internalType: 'uint256', name: 'expireTime', type: 'uint256' },
    ],
  ...
  {
    anonymous: false,
    inputs: [{ indexed: true, internalType: 'address', name: 'licenseTemplate', type: 'address' }],
  ...
  },
  {
    ...
    outputs: [{ internalType: 'address', name: 'childIpId', type: 'address' }],
    stateMutability: 'view',
    type: 'function',
  },
  {
    inputs: [{ internalType: 'address', name: 'parentIpId', type: 'address' }],
  ...
  },
  {
    ...
    name: 'getParentIp',
    outputs: [{ internalType: 'address', name: 'parentIpId', type: 'address' }],
    stateMutability: 'view',
    type: 'function',
  },
  {
  ...
  },
  {
    inputs: [
      { internalType: 'address', name: 'newLicenseTemplate', type: 'address' },
      { internalType: 'uint256', name: 'newLicenseTermsId', type: 'uint256' },
    ],
  ...
  },
  {
    inputs: [
      ...
      { internalType: 'address', name: 'licenseTemplate', type: 'address' },
      { internalType: 'uint256', name: 'licenseTermsId', type: 'uint256' },
      { internalType: 'bool', name: 'isMintedByIpOwner', type: 'bool' },
    ],
