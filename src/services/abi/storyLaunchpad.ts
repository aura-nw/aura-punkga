export const storyLaunchpadAbi = [
  {
  ...
  },
  {
    anonymous: false,
    inputs: [
      { indexed: true, internalType: 'address', name: '_licenseAddress', type: 'address' },
      { indexed: true, internalType: 'uint256', name: '_licenseTokenId', type: 'uint256' },
      {
        components: [
          { internalType: 'address payable', name: 'creator', type: 'address' },
          { internalType: 'address', name: 'licenseAddress', type: 'address' },
          { internalType: 'uint256', name: 'licenseTokenId', type: 'uint256' },
  ...
  },
  {
    ...
    outputs: [
      ...
      { internalType: 'string', name: 'uriLauchpad', type: 'string' },
  ...
  {
    inputs: [
      { internalType: 'address', name: '_licenseAddress', type: 'address' },
  ...
  },
  {
    inputs: [
      { internalType: 'address', name: '_licenseAddress', type: 'address' },
      { internalType: 'uint256', name: '_licenseTokenId', type: 'uint256' },
