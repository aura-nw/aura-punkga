...
export default function Analytic() {
  ...
  return (
    <div className='bg-[#F2F2F2] px-[30px] md:px-10 py-5 rounded-2xl h-[180px] flex flex-col justify-between'>
      <div className='md:text-xl leading-5 md:leading-6 font-bold text-[#1C1C1C]'>{t('Quests Analytic')}</div>
      <div className='flex'>
        <div className='mr-auto'>
          <div className='text-xs md:text-sm leading-[15px] md:leading-[18px] text-[#1C1C1C]'>{t('Level')}</div>
        ...
        <div className='mx-auto'>
          <div className='text-xs md:text-sm leading-[15px] md:leading-[18px] text-[#1C1C1C]'>{t('Completed Quests')}</div>
          <div className='mt-1 text-[#1C1C1C] font-bold text-base md:text-lg leading-[24px]'>{account.quests}</div>
        </div>
        <span className='w-[1px] h-full bg-[#1c1c1c]/10'></span>
        <div className='ml-auto'>
          <div className='text-xs md:text-sm leading-[15px] md:leading-[18px] text-[#1C1C1C]'>{t('Current XP')}</div>
          <div className='mt-1 text-[#1C1C1C] font-bold text-base md:text-lg leading-[24px]'>{account.xp}</div>
        </div>
      </div>
      <div>
        <div className='mb-1 text-xs md:text-sm leading-[15px] md:leading-[18px]'>{t('Progress')}</div>
