  ...
  return (
    <Head>
      ...
      <meta
        ...
        content={
          description ||
          "PUNKGA is a project with a focus on establishing a professional playground for Cyberpunk comic artists. Manga artists create NFTs and encourage community participation through sharing and engagement in the story. Users will have the opportunity to own unique digital artworks and actively contribute to the story's development in a positive manner."
        }></meta>
