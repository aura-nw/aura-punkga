...
export default function ForgotPasswordModal({ onClose }) {
  ...
  return (
    <div
      ...
      <p className="text-2xl leading-6 font-semibold text-center ">Forgot password?</p>
      <div className="h-full relative">
        <Transition
          ...
          leaveTo="opacity-0">
          <div>
            <p className="text-xs leading-[14px] text-center">Kindly enter the email linked to your account,</p>
            <p className="text-xs leading-[14px] text-center">we’ll send you a link to reset password</p>
          </div>
          <OutlineTextField label="Email" placeholder="Enter email address" value={email} onChange={setEmail} />
          <FilledButton
        ...
        <Transition
          ...
          <div className="flex flex-col text-center">
            ...
            <p className="line-clamp-1">
              Or <span className="text-second-color font-semibold cursor-pointer">sign up</span> with another email
            </p>
          </div>
        </Transition>
      </div>
