  ...
  return (
    <>
      ...
      <header
        ...
        <nav className='lg:hidden pk-container py-[10px] px-4 shadow-[0px_4px_4px_0px_#0000001A]'>
          ...
          {openNavigation && (
            ...
            >
              ...
              {account?.verified && account?.name && (
                <div className='bg-[#F2F2F2] p-4 rounded-xl'>
                  ...
                  <div className='flex justify-between items-center text-[#4E5056] text-base font-semibold leading-5'>
                    ...
                    <span className='inline-block'>
                      {
                        <div className='ml-2 w-[15px] h-[15px] relative'>
                          <svg
                            xmlns='http://www.w3.org/2000/svg'
                            width='15'
                            height='15'
              ...
              <div>
                <div className='flex justify-between gap-3 items-center py-4 text-sm leading-[18px] text-[#414141] font-semibold'
        ...
        <div className='lg:hidden pk-container py-[10px] px-5 bg-[#F4F3F7] pb-4'>
          <div
            ref={divRef}
            className={`${isSearchFocused ? 'z-30' : ''
              } w-full max-w-max relative`}>
            <TextField
              inputref={ref}
              onChange={_.debounce(setSearchValue, 500)}
              onFocus={() => setIsSearchFocused(true)}
              className='bg-[#FDFDFD] border-[#BDBDBD] border-[1px] duration-500 !w-max'
              size='lg'
