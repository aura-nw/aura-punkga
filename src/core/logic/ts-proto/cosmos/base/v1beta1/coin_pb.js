...
if (goog.DEBUG && !COMPILED) {
   ...
   * @override
   */
  proto.cosmos.base.v1beta1.DecCoin.displayName =
...
if (goog.DEBUG && !COMPILED) {
   ...
   * @override
   */
  proto.cosmos.base.v1beta1.IntProto.displayName =
    'proto.cosmos.base.v1beta1.IntProto';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
...
if (goog.DEBUG && !COMPILED) {
   ...
   * @override
   */
  proto.cosmos.base.v1beta1.DecProto.displayName =
    'proto.cosmos.base.v1beta1.DecProto';
}
...
if (jspb.Message.GENERATE_TO_OBJECT) {
   ...
   * @return {!Object}
   */
  proto.cosmos.base.v1beta1.Coin.prototype.toObject = function (
    opt_includeInstance
  ) {
...
proto.cosmos.base.v1beta1.Coin.deserializeBinary = function (bytes) {
  ...
  return proto.cosmos.base.v1beta1.Coin.deserializeBinaryFromReader(
    msg,
    reader
  );
};
 ...
 * @return {!proto.cosmos.base.v1beta1.Coin}
 */
proto.cosmos.base.v1beta1.Coin.deserializeBinaryFromReader = function (
  msg,
  reader
) {
 ...
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.cosmos.base.v1beta1.Coin.serializeBinaryToWriter = function (
  message,
  writer
) {
  var f = undefined;
...
if (jspb.Message.GENERATE_TO_OBJECT) {
   ...
   * @return {!Object}
   */
  proto.cosmos.base.v1beta1.DecCoin.prototype.toObject = function (
    opt_includeInstance
  ) {
    return proto.cosmos.base.v1beta1.DecCoin.toObject(
      opt_includeInstance,
      this
    );
  };
...
proto.cosmos.base.v1beta1.DecCoin.deserializeBinary = function (bytes) {
  ...
  return proto.cosmos.base.v1beta1.DecCoin.deserializeBinaryFromReader(
    msg,
    reader
  );
};
 ...
 * @return {!proto.cosmos.base.v1beta1.DecCoin}
 */
proto.cosmos.base.v1beta1.DecCoin.deserializeBinaryFromReader = function (
  msg,
  reader
) {
  while (reader.nextField()) {
 ...
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.cosmos.base.v1beta1.DecCoin.serializeBinaryToWriter = function (
  message,
  writer
) {
  var f = undefined;
...
if (jspb.Message.GENERATE_TO_OBJECT) {
   ...
   * @return {!Object}
   */
  proto.cosmos.base.v1beta1.IntProto.prototype.toObject = function (
    opt_includeInstance
  ) {
    return proto.cosmos.base.v1beta1.IntProto.toObject(
      opt_includeInstance,
      this
    );
  };
   ...
   * @suppress {unusedLocalVariables} f is only used for nested messages
   */
  proto.cosmos.base.v1beta1.IntProto.toObject = function (
    includeInstance,
    msg
  ) {
    var obj = {
...
proto.cosmos.base.v1beta1.IntProto.deserializeBinary = function (bytes) {
  ...
  return proto.cosmos.base.v1beta1.IntProto.deserializeBinaryFromReader(
    msg,
    reader
  );
};
 ...
 * @return {!proto.cosmos.base.v1beta1.IntProto}
 */
proto.cosmos.base.v1beta1.IntProto.deserializeBinaryFromReader = function (
  msg,
  reader
) {
  while (reader.nextField()) {
 ...
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.cosmos.base.v1beta1.IntProto.serializeBinaryToWriter = function (
  message,
  writer
) {
  var f = undefined;
...
if (jspb.Message.GENERATE_TO_OBJECT) {
   ...
   * @return {!Object}
   */
  proto.cosmos.base.v1beta1.DecProto.prototype.toObject = function (
    opt_includeInstance
  ) {
    return proto.cosmos.base.v1beta1.DecProto.toObject(
      opt_includeInstance,
      this
    );
  };
   ...
   * @suppress {unusedLocalVariables} f is only used for nested messages
   */
  proto.cosmos.base.v1beta1.DecProto.toObject = function (
    includeInstance,
    msg
  ) {
    var f,
...
proto.cosmos.base.v1beta1.DecProto.deserializeBinary = function (bytes) {
  ...
  return proto.cosmos.base.v1beta1.DecProto.deserializeBinaryFromReader(
    msg,
    reader
  );
};
 ...
 * @return {!proto.cosmos.base.v1beta1.DecProto}
 */
proto.cosmos.base.v1beta1.DecProto.deserializeBinaryFromReader = function (
  msg,
  reader
) {
  while (reader.nextField()) {
 ...
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.cosmos.base.v1beta1.DecProto.serializeBinaryToWriter = function (
  message,
  writer
) {
  var f = undefined;
