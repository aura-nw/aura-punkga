...
function PageContent() {
  ...
  const { data: artworkData } = useSWR({ key: 'get-artwork', id: artworkId, userId: account?.id }, ({ id, userId }) =>
    contentService.artwork.getArtworkDetail(userId, id)
  )
  ...
  return (
    <div className='bg-background min-h-screen text-white'>
      ...
      <InfiniteScroll
        className='px-4 space-y-10 mt-10'
