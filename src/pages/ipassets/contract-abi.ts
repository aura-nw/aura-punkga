export const licenseContractAbi = [
  {
    inputs: [
  ...
  { inputs: [], name: 'LicenseToken__CallerNotLicensingModule', type: 'error' },
  {
    inputs: [
      { internalType: 'uint256', name: 'tokenId', type: 'uint256' },
      { internalType: 'address', name: 'iPowner', type: 'address' },
      { internalType: 'address', name: 'tokenOwner', type: 'address' },
    ],
    name: 'LicenseToken__NotLicenseTokenOwner',
    type: 'error',
  },
  { inputs: [], name: 'LicenseToken__NotTransferable', type: 'error' },
  {
    inputs: [{ internalType: 'uint256', name: 'tokenId', type: 'uint256' }],
    name: 'LicenseToken__RevokedLicense',
    type: 'error',
  },
  { inputs: [], name: 'LicenseToken__ZeroAccessManager', type: 'error' },
  ...
  },
  {
    ...
    name: 'DISPUTE_MODULE',
    outputs: [
      { internalType: 'contract IDisputeModule', name: '', type: 'address' },
    ],
  ...
  },
  {
    ...
    outputs: [
      { internalType: 'uint256', name: 'startLicenseTokenId', type: 'uint256' },
    ],
    stateMutability: 'nonpayable',
    type: 'function',
  },
  ...
  },
  {
    ...
    outputs: [
      { internalType: 'address', name: 'licenseTemplate', type: 'address' },
      { internalType: 'address[]', name: 'licensorIpIds', type: 'address[]' },
