        ...
        <div className='pk-container px-5 lg:px-0'>
          <div className='flex gap-4 lg:gap-16 mt-[50px] lg:mt-24 items-start'>
            ...
            <div className='font-bold '>
              ...
              <div className='text-2xl text-[#61646b] leading-[30px] mt-5 lg:text-4xl 2xl:text-[48px] 2xl:leading-[60px] lg:max-w-[45vw]'>
                {locale == 'vn'
          ...
          <div
            ...
            <div className='relative'>
              <div className='text-[8px] min-[425px]:text-[10px] leading-[13px] text-[#828282] text-justify min-h-[137px] lg:text-lg lg:leading-[24px] lg:max-w-[690px] lg:w-[38vw]'>
                {locale == 'vn'
