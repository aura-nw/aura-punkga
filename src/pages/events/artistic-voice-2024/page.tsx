...
import Background from 'components/pages/event/find-your-artistic-voice/assets/onboarding-bg.svg'
import Door from 'components/pages/event/find-your-artistic-voice/assets/door.svg'
import ActiveMap from 'components/pages/event/find-your-artistic-voice/assets/active-map.svg'
import Map from 'components/pages/event/find-your-artistic-voice/assets/map.svg'
import ActiveSketch from 'components/pages/event/find-your-artistic-voice/assets/active-sketch.svg'
import Sketch from 'components/pages/event/find-your-artistic-voice/assets/sketch.svg'
import ActiveLamp from 'components/pages/event/find-your-artistic-voice/assets/active-lamp.svg'
import Lamp from 'components/pages/event/find-your-artistic-voice/assets/lamp.svg'
import Artkeeper from 'components/pages/event/find-your-artistic-voice/assets/Artkeeper.svg'
import GuideBox from 'components/pages/event/find-your-artistic-voice/assets/guide-box.svg'
