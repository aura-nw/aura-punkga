...
export default function SubscribedManga(props) {
  if (props.justHead) {
    return <></>;
  }
      ...
      <div className="container mx-auto flex gap-8 mt-4 md:mt-8 ">
        ...
        <div className="flex flex-col gap-8">
          ...
          <div className="flex flex-col bg-[#1D1F1E] rounded-[10px] lg:mt-8">
            <div className="flex w-full justify-between items-center bg-[#0A0A0A] rounded-tl-md rounded-tR-md py-[10px] px-7">
              <div className="flex gap-2 items-baseline md:text-xl text-2xl leading-[28px] font-medium text-[#F6F6F6]">
                <Image src={MangaHeadingIcon} alt={""} width={30} height={21}></Image>
                {t("Following")}
              </div>
              <Link className="text-[#888] text-sm font-semibold" href={'/explore/manga/following'}>View All</Link>
            </div>
