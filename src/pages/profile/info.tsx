...
export default function Info() {
  ...
  return (
    <div className='relative w-full aspect-[519/595]'>
      ...
      <div className='top-[5.5%] left-[9.25%] right-[4.5%] absolute grid grid-cols-2 items-end gap-[7px]'>
        ...
        <div className='flex justify-between flex-col w-full h-full'>
          ...
          <div className='relative'>
            ...
            <div className='absolute inset-0 grid place-items-center text-second-color font-semibold'>Save</div>
          </div>
        </div>
      </div>
      ...
      <div className='ml-[9.25%] relative'>
        ...
        <div className='absolute top-[12%] left-[1%]'>{account.name}</div>
      </div>
    </div>
  )
}
