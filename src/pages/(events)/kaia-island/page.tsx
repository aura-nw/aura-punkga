...
import BannerDesktop from 'components/pages/event/assets/banner-desktop-v3.png'
            ...
            <ol className="ist-decimal list-inside pl-5 [&>li]:mt-2 nested-counter text-sm [counter-reset:item] [&_ol]:[counter-reset:item] [&>li]:[counter-increment:item] [&>li::marker]:[content:counters(item,'.')_'._'] [&_ol>li]:[counter-increment:item] [&_ol>li::marker]:[content:counters(item,'.')_'._']">
              ...
              <li className='font-bold'>
                ...
                <ul className='list-disc list-inside pl-5 font-normal'>
                  ...
                  <li>
                    TOP 10: Do Ban Giám Khảo và ban cố vấn bình chọn sẽ nhận được 5 điểm cộng tính vào kết quả chung
                    cuộc!
                  </li>
                </ul>
              </li>
            ...
            <ol className="ist-decimal list-inside pl-5 [&>li]:mt-2 nested-counter text-sm [counter-reset:item] [&_ol]:[counter-reset:item] [&>li]:[counter-increment:item] [&>li::marker]:[content:counters(item,'.')_'._'] [&_ol>li]:[counter-increment:item] [&_ol>li::marker]:[content:counters(item,'.')_'._']">
              ...
              <li className='font-bold'>
                ...
                <ul className='list-disc list-inside pl-5 font-normal'>
                  ...
                  <li>
                    TOP 10: Selected by the Judges and Advisory Board, each artist will receive 5 bonus points added to
                    their final score.
                  </li>
                </ul>
              </li>
